...
from .BorrarPantalla import clean as LimpiarPantalla 
...
def funcion_lista_jugadores():
    ...
    while True:
        ...
        if jugadores[iterador] == "1":
            ...
            if len(jugadores) == 0:
                input("No hay ningún jugador introducido. Pulse cualquier tecla")
                LimpiarPantalla()
            else:
            ...
            if len(jugadores) == 0:
                input("La lista está vacía. Pulse cualquier tecla")
                LimpiarPantalla()

            elif len(jugadores) < 3:
                input("No hay suficientes jugadores metidos. Pulse cualquier tecla")
                LimpiarPantalla()
